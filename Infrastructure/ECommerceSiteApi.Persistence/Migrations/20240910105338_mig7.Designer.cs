            ...
            modelBuilder.Entity("ECommerceSiteApi.Domain.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a295d121-6bac-4dde-be8f-0ffc812fc028"),
                            CreatedDate = new DateTime(2024, 9, 10, 13, 53, 38, 356, DateTimeKind.Local).AddTicks(9159),
                            Name = "Bilgisayar",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("be6a13c1-f1a4-4db0-99ee-5ad0a36dc202"),
                            CreatedDate = new DateTime(2024, 9, 10, 13, 53, 38, 356, DateTimeKind.Local).AddTicks(9188),
                            Name = "Ütü",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("8193f620-655f-4012-a5ee-158ad0bb739f"),
                            CreatedDate = new DateTime(2024, 9, 10, 13, 53, 38, 356, DateTimeKind.Local).AddTicks(9190),
                            Name = "Makyaj",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("5175fd22-198e-464c-9026-6e863fce4e36"),
                            CreatedDate = new DateTime(2024, 9, 10, 13, 53, 38, 356, DateTimeKind.Local).AddTicks(9192),
                            Name = "Buzdolabı",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("5677c423-66dd-420d-951e-dba5b8ce8e21"),
                            CreatedDate = new DateTime(2024, 9, 10, 13, 53, 38, 356, DateTimeKind.Local).AddTicks(9206),
