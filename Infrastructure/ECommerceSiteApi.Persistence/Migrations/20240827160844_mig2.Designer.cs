            ...
            modelBuilder.Entity("ECommerceSiteApi.Domain.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0dae7362-5acb-458b-84be-c3838018a306"),
                            CreatedDate = new DateTime(2024, 8, 27, 19, 8, 44, 23, DateTimeKind.Local).AddTicks(6173),
                            Name = "Bilgisayar",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("f8f25e8f-b6d2-45ea-b534-9c1570ddd651"),
                            CreatedDate = new DateTime(2024, 8, 27, 19, 8, 44, 23, DateTimeKind.Local).AddTicks(6212),
                            Name = "Ütü",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("204c9225-809f-445b-9eec-e1b5fc3cdea4"),
                            CreatedDate = new DateTime(2024, 8, 27, 19, 8, 44, 23, DateTimeKind.Local).AddTicks(6214),
                            Name = "Makyaj",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("1b92efc0-f570-499f-8137-f3ccf971e574"),
                            CreatedDate = new DateTime(2024, 8, 27, 19, 8, 44, 23, DateTimeKind.Local).AddTicks(6215),
                            Name = "Buzdolabı",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("5770e463-80c9-4fc4-ae35-7d5f869d4f73"),
                            CreatedDate = new DateTime(2024, 8, 27, 19, 8, 44, 23, DateTimeKind.Local).AddTicks(6227),
