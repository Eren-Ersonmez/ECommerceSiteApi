...
namespace ECommerceSiteApi.Persistence.Migrations
{
    ...
    [Migration("20240916114811_mig15")]
    partial class mig15
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ECommerceSiteApi.Domain.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fbd2ecc0-b63a-4883-b942-c3a37ecd0e29"),
                            CreatedDate = new DateTime(2024, 9, 16, 14, 48, 11, 554, DateTimeKind.Local).AddTicks(5891),
                            Name = "Bilgisayar",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("f8d90e7a-1136-4533-aab5-db3bff13c7a0"),
                            CreatedDate = new DateTime(2024, 9, 16, 14, 48, 11, 554, DateTimeKind.Local).AddTicks(5984),
                            Name = "Ütü",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("30602e13-2465-4883-a3b8-09734eb677b7"),
                            CreatedDate = new DateTime(2024, 9, 16, 14, 48, 11, 554, DateTimeKind.Local).AddTicks(5985),
                            Name = "Makyaj",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("96ffd376-9080-4aa2-ad79-a94cadf12452"),
                            CreatedDate = new DateTime(2024, 9, 16, 14, 48, 11, 554, DateTimeKind.Local).AddTicks(5987),
                            Name = "Buzdolabı",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("41a98ed4-f610-415f-ad86-aafa448e2d81"),
                            CreatedDate = new DateTime(2024, 9, 16, 14, 48, 11, 554, DateTimeKind.Local).AddTicks(5988),
