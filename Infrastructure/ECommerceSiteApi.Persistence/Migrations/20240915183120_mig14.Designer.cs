...
namespace ECommerceSiteApi.Persistence.Migrations
{
    ...
    [Migration("20240915183120_mig14")]
    partial class mig14
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ECommerceSiteApi.Domain.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("db0ff65c-0e7f-4e0a-bf8e-b2084552f47a"),
                            CreatedDate = new DateTime(2024, 9, 15, 21, 31, 20, 181, DateTimeKind.Local).AddTicks(7985),
                            Name = "Bilgisayar",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("e56ccdf0-6d2b-43b8-b0a5-a9d10481df72"),
                            CreatedDate = new DateTime(2024, 9, 15, 21, 31, 20, 181, DateTimeKind.Local).AddTicks(8043),
                            Name = "Ütü",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("5bba441b-9d52-4457-b3b5-05a1b6c27c80"),
                            CreatedDate = new DateTime(2024, 9, 15, 21, 31, 20, 181, DateTimeKind.Local).AddTicks(8045),
                            Name = "Makyaj",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("e08b6d7f-06b8-4f0f-96d3-2898f877873a"),
                            CreatedDate = new DateTime(2024, 9, 15, 21, 31, 20, 181, DateTimeKind.Local).AddTicks(8046),
                            Name = "Buzdolabı",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("fe503ee5-4730-41ba-b2ca-5d57295d7774"),
                            CreatedDate = new DateTime(2024, 9, 15, 21, 31, 20, 181, DateTimeKind.Local).AddTicks(8061),
