...
namespace ECommerceSiteApi.Persistence.Migrations
{
    ...
    [Migration("20240913190854_mig12")]
    partial class mig12
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ECommerceSiteApi.Domain.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f6283593-abdb-49d7-8d7e-9dea6e648d37"),
                            CreatedDate = new DateTime(2024, 9, 13, 22, 8, 54, 506, DateTimeKind.Local).AddTicks(1098),
                            Name = "Bilgisayar",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("61e3e658-f678-41f6-8e8d-f26a68e398f7"),
                            CreatedDate = new DateTime(2024, 9, 13, 22, 8, 54, 506, DateTimeKind.Local).AddTicks(1141),
                            Name = "Ütü",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("24f0e22e-c4c7-4d69-b310-c1c2e1e134a2"),
                            CreatedDate = new DateTime(2024, 9, 13, 22, 8, 54, 506, DateTimeKind.Local).AddTicks(1154),
                            Name = "Makyaj",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("a9a3a4b0-66ac-4a67-a29b-c0a15471aaf4"),
                            CreatedDate = new DateTime(2024, 9, 13, 22, 8, 54, 506, DateTimeKind.Local).AddTicks(1156),
                            Name = "Buzdolabı",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("8252c2ba-d024-43be-bedb-0007a14f7741"),
                            CreatedDate = new DateTime(2024, 9, 13, 22, 8, 54, 506, DateTimeKind.Local).AddTicks(1158),
