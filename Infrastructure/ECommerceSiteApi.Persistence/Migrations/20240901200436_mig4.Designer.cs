            ...
            modelBuilder.Entity("ECommerceSiteApi.Domain.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ac840f0c-871b-427c-a6dc-9514bfadf8f8"),
                            CreatedDate = new DateTime(2024, 9, 1, 23, 4, 35, 752, DateTimeKind.Local).AddTicks(8983),
                            Name = "Bilgisayar",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("e2ae81a3-a3d4-400c-b56f-d601c8ebdd53"),
                            CreatedDate = new DateTime(2024, 9, 1, 23, 4, 35, 752, DateTimeKind.Local).AddTicks(9023),
                            Name = "Ütü",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("91b92396-2bda-40e4-bf43-292956265f1a"),
                            CreatedDate = new DateTime(2024, 9, 1, 23, 4, 35, 752, DateTimeKind.Local).AddTicks(9025),
                            Name = "Makyaj",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("184d2c8f-90d5-44d2-9a03-45a56070b8e4"),
                            CreatedDate = new DateTime(2024, 9, 1, 23, 4, 35, 752, DateTimeKind.Local).AddTicks(9027),
                            Name = "Buzdolabı",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("9cf2f489-e183-4545-9019-1e399edcf4ac"),
                            CreatedDate = new DateTime(2024, 9, 1, 23, 4, 35, 752, DateTimeKind.Local).AddTicks(9036),
