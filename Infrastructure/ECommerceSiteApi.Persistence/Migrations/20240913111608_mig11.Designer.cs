...
namespace ECommerceSiteApi.Persistence.Migrations
{
    ...
    [Migration("20240913111608_mig11")]
    partial class mig11
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ECommerceSiteApi.Domain.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a4ee0a31-d867-477b-8897-1d435220c70f"),
                            CreatedDate = new DateTime(2024, 9, 13, 14, 16, 8, 504, DateTimeKind.Local).AddTicks(6833),
                            Name = "Bilgisayar",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("1434a870-8190-49d5-82ef-57860880f31a"),
                            CreatedDate = new DateTime(2024, 9, 13, 14, 16, 8, 504, DateTimeKind.Local).AddTicks(6875),
                            Name = "Ütü",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("16003366-e3f2-45dc-88da-9f584f1dbbe0"),
                            CreatedDate = new DateTime(2024, 9, 13, 14, 16, 8, 504, DateTimeKind.Local).AddTicks(6877),
                            Name = "Makyaj",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("f3d1a3a7-69c0-4dd0-baaf-a72e9da3d2fa"),
                            CreatedDate = new DateTime(2024, 9, 13, 14, 16, 8, 504, DateTimeKind.Local).AddTicks(6879),
                            Name = "Buzdolabı",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("5dfc37bf-719e-4761-adbf-05f0a68fea94"),
                            CreatedDate = new DateTime(2024, 9, 13, 14, 16, 8, 504, DateTimeKind.Local).AddTicks(6880),
