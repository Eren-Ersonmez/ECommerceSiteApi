            ...
            modelBuilder.Entity("ECommerceSiteApi.Domain.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d6be0671-9784-44b2-b439-d473d5663b5c"),
                            CreatedDate = new DateTime(2024, 9, 2, 16, 58, 10, 408, DateTimeKind.Local).AddTicks(8596),
                            Name = "Bilgisayar",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("a94d6e6b-e939-46be-9db6-1da0c4c2199f"),
                            CreatedDate = new DateTime(2024, 9, 2, 16, 58, 10, 408, DateTimeKind.Local).AddTicks(8635),
                            Name = "Ütü",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("d326f81f-72c7-479c-bc26-fd78fc748f30"),
                            CreatedDate = new DateTime(2024, 9, 2, 16, 58, 10, 408, DateTimeKind.Local).AddTicks(8637),
                            Name = "Makyaj",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("74e0d027-13e4-4f90-979e-dc0db6207bb3"),
                            CreatedDate = new DateTime(2024, 9, 2, 16, 58, 10, 408, DateTimeKind.Local).AddTicks(8655),
                            Name = "Buzdolabı",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("c8bfca95-f1f9-49d9-b9b8-d1c3d097eca9"),
                            CreatedDate = new DateTime(2024, 9, 2, 16, 58, 10, 408, DateTimeKind.Local).AddTicks(8656),
