...
namespace ECommerceSiteApi.Persistence.Migrations
{
    ...
    [Migration("20240914170143_mig13")]
    partial class mig13
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ECommerceSiteApi.Domain.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("50087bbe-8780-4875-b5bb-c38080840110"),
                            CreatedDate = new DateTime(2024, 9, 14, 20, 1, 43, 383, DateTimeKind.Local).AddTicks(6421),
                            Name = "Bilgisayar",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("a7fa0f1e-09f4-47e3-89b5-464ab03930df"),
                            CreatedDate = new DateTime(2024, 9, 14, 20, 1, 43, 383, DateTimeKind.Local).AddTicks(6465),
                            Name = "Ütü",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("a9ff7729-9091-4e9d-b745-531f7e562c71"),
                            CreatedDate = new DateTime(2024, 9, 14, 20, 1, 43, 383, DateTimeKind.Local).AddTicks(6466),
                            Name = "Makyaj",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("46f2cd1a-d76b-4b02-a4c9-57c76b549aa5"),
                            CreatedDate = new DateTime(2024, 9, 14, 20, 1, 43, 383, DateTimeKind.Local).AddTicks(6468),
                            Name = "Buzdolabı",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("e144d460-3925-48c6-b79d-a0aecd740dc7"),
                            CreatedDate = new DateTime(2024, 9, 14, 20, 1, 43, 383, DateTimeKind.Local).AddTicks(6480),
