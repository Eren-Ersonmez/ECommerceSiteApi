            ...
            modelBuilder.Entity("ECommerceSiteApi.Domain.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("45584ea8-06aa-4867-bbad-2e20eef2bffe"),
                            CreatedDate = new DateTime(2024, 9, 1, 12, 24, 10, 435, DateTimeKind.Local).AddTicks(9878),
                            Name = "Bilgisayar",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("b0a6f1b0-3f51-4c0c-af0f-631e49150816"),
                            CreatedDate = new DateTime(2024, 9, 1, 12, 24, 10, 435, DateTimeKind.Local).AddTicks(9925),
                            Name = "Ütü",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("016d95c1-da2b-4433-825a-2d2b1d4bafa7"),
                            CreatedDate = new DateTime(2024, 9, 1, 12, 24, 10, 435, DateTimeKind.Local).AddTicks(9926),
                            Name = "Makyaj",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("2e8641f6-7e1f-4162-87c4-e9274b35ab31"),
                            CreatedDate = new DateTime(2024, 9, 1, 12, 24, 10, 435, DateTimeKind.Local).AddTicks(9928),
                            Name = "Buzdolabı",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("853552c3-3efa-4f7e-8d3e-1b3c83de70f3"),
                            CreatedDate = new DateTime(2024, 9, 1, 12, 24, 10, 435, DateTimeKind.Local).AddTicks(9952),
