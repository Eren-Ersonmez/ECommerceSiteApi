...
namespace ECommerceSiteApi.Persistence.Migrations
{
    ...
    [Migration("20240911174129_mig10")]
    partial class mig10
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ECommerceSiteApi.Domain.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0b517246-8ad5-4ebd-8cb4-414f304e48b7"),
                            CreatedDate = new DateTime(2024, 9, 11, 20, 41, 28, 681, DateTimeKind.Local).AddTicks(6558),
                            Name = "Bilgisayar",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("382a0e4e-9239-470c-a3e8-6f828c0c6301"),
                            CreatedDate = new DateTime(2024, 9, 11, 20, 41, 28, 681, DateTimeKind.Local).AddTicks(6601),
                            Name = "Ütü",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("f37bd8eb-900f-4d1b-985d-7a1ef598d12f"),
                            CreatedDate = new DateTime(2024, 9, 11, 20, 41, 28, 681, DateTimeKind.Local).AddTicks(6603),
                            Name = "Makyaj",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("e5d00aac-a754-4096-94e5-6407ecad6d31"),
                            CreatedDate = new DateTime(2024, 9, 11, 20, 41, 28, 681, DateTimeKind.Local).AddTicks(6604),
                            Name = "Buzdolabı",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("021a7391-1e36-4638-9bf1-1037cbc96958"),
                            CreatedDate = new DateTime(2024, 9, 11, 20, 41, 28, 681, DateTimeKind.Local).AddTicks(6606),
