...
namespace ECommerceSiteApi.Persistence.Migrations
{
    ...
    [Migration("20240826153443_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerceSiteApi.Domain.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f6c2fde0-70b3-42e2-af9d-8ae06cb02564"),
                            CreatedDate = new DateTime(2024, 8, 26, 18, 34, 43, 105, DateTimeKind.Local).AddTicks(1257),
                            Name = "Bilgisayar",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("8724d5a6-05b3-4ba3-b928-03ef01d8cfef"),
                            CreatedDate = new DateTime(2024, 8, 26, 18, 34, 43, 105, DateTimeKind.Local).AddTicks(1313),
                            Name = "Ütü",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("95be799d-99c3-405a-8cd3-77546ce4dcad"),
                            CreatedDate = new DateTime(2024, 8, 26, 18, 34, 43, 105, DateTimeKind.Local).AddTicks(1315),
                            Name = "Makyaj",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("9fa0db82-e6db-4387-b0d7-546c5190a060"),
                            CreatedDate = new DateTime(2024, 8, 26, 18, 34, 43, 105, DateTimeKind.Local).AddTicks(1317),
                            Name = "Buzdolabı",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("7bb545c5-4421-40cb-82f1-3a5c61ee66b4"),
                            CreatedDate = new DateTime(2024, 8, 26, 18, 34, 43, 105, DateTimeKind.Local).AddTicks(1318),
            ...
            modelBuilder.Entity("ECommerceSiteApi.Domain.Models.OrderDetails", b =>
                {
                    b.HasOne("ECommerceSiteApi.Domain.Models.Order", null)
