            ...
            modelBuilder.Entity("ECommerceSiteApi.Domain.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6adbe85f-5f09-4247-846b-728f1a928db6"),
                            CreatedDate = new DateTime(2024, 9, 11, 20, 32, 42, 621, DateTimeKind.Local).AddTicks(3023),
                            Name = "Bilgisayar",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("f66f0837-29cf-4715-983c-e02f7da324fa"),
                            CreatedDate = new DateTime(2024, 9, 11, 20, 32, 42, 621, DateTimeKind.Local).AddTicks(3073),
                            Name = "Ütü",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("06266bbc-a37f-4e87-9069-47cf33a4e488"),
                            CreatedDate = new DateTime(2024, 9, 11, 20, 32, 42, 621, DateTimeKind.Local).AddTicks(3075),
                            Name = "Makyaj",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("673c0f9e-c819-43aa-987b-cd32f3831f29"),
                            CreatedDate = new DateTime(2024, 9, 11, 20, 32, 42, 621, DateTimeKind.Local).AddTicks(3076),
                            Name = "Buzdolabı",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = new Guid("c9e6510b-b509-4f88-bd3d-35f4ea1426d0"),
                            CreatedDate = new DateTime(2024, 9, 11, 20, 32, 42, 621, DateTimeKind.Local).AddTicks(3078),
